...
class _SendNotificationScreenState extends State<SendNotificationScreen> {
    ...
    if (_formKey.currentState.validate()) {
      ...
      if (selectedType == null || selectedLang == null) {
        ...
        var refundRes = await http.post(
          Uri.parse(
              'https://us-central1-app-jeras.cloudfunctions.net/sendNewNotification'),
  ...
  Widget build(BuildContext context) {
    ...
    _typeArray = [
      KeyValueModel( key: "CONSULTANT", value: getTranslated(context, "consultNum")),
      KeyValueModel(key: "USER", value: getTranslated(context, "userNum")),
      KeyValueModel( key: "SUPPORT", value: getTranslated(context, "supportNum")),
    ];
                      ...
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: _typeArray.map((data) => DropdownMenuItem<String>(
                                      child: Text(
                                        data.value,
                                        style: GoogleFonts.cairo(
                                          color: Colors.black,
