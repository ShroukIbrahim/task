...
class NotificationItem extends StatelessWidget {
  ...
  const NotificationItem({
    ...
    @required this.index,
    @required this.notificationList, this.theme,
  });
    ...
    return InkWell(
      ...
      onTap: () async {
        try{
          ...
          if(notificationList[index].notificationType=="Review_Notification") {
            // StoreRedirect.redirect(androidAppId: 'com.abdulazizahmed.dream',iOSAppId: '1515745954');
            print(notificationList[index].appointmentId);
            ...
            if(querySnapshot.size>0)
            {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AddReviewScreen(consultId: notificationList[index].consultUid,userId:notificationList[index].userUid,appointmentId:notificationList[index].appointmentId),
                ),
              );
          }
          else if(notificationList[index].notificationType=="Appointment_Notification"&&notificationList[index].type=="consult")
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) =>
          ...
          else if(notificationList[index].notificationType=="Appointment_Notification"&&notificationList[index].type=="user")
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) =>
          ...
          else if(notificationList[index].notificationType=="TechnicalSupport")
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) =>
          ...
          else if(notificationList[index].notificationType=="Chat")
          {
            ...
            DocumentReference docRef2 = FirebaseFirestore.instance.collection(Paths.appAppointments).doc(notificationList[index].appointmentId);
            ...
            if(appointment.appointmentStatus!="closed"&&appointment.appointmentStatus!="cancel")
              Navigator.push(
                context,
                MaterialPageRoute(
...
*/
            ...
            final DocumentSnapshot documentSnapshot2 = await docRef2.get();
            var appointment = AppAppointments.fromFirestore(documentSnapshot2);
            if(appointment.appointmentStatus!="closed"&&appointment.appointmentStatus!="cancel"&&appointment.allowCall)
              Navigator.push(
                context,
                MaterialPageRoute(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              notificationList[index].notificationTitle,// '${notificationList[index].notificationTitle}',
